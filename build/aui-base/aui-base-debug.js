		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-tree': {submodules: {'aui-tree-io': {requires:['aui-io','json'], skinnable:false}, 'aui-tree-view': {requires:['aui-tree-node','aui-tree-paginator','dd-drag','dd-drop','dd-proxy'], skinnable:true}, 'aui-tree-paginator': {requires:['aui-base'], skinnable:false}, 'aui-tree-node': {requires:['aui-tree-data','aui-tree-io','aui-tree-paginator','json','querystring-stringify'], skinnable:false}, 'aui-tree-data': {requires:['aui-base','aui-task-manager'], skinnable:false} }, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-io', 'aui-tree-paginator', 'aui-tree-view'], skinnable:true},
